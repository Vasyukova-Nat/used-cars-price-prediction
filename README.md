...
Помочь платформе по продаже подержанных авто оценивать машины объективно, на основе реальных данных: обучить и сравнить ансамблевые методы, выбрав лучший по соотношению точность/сложность.
